...
- 🖼️ **Ente:** End‑to‑end encrypted photo server with zero‑knowledge design.
- ☁️ **Agros:** Private cloud to save and sync files on your terms.
- 💬 **Matrix + LiveKit:** Modern chat + real‑time voice/video via SFU.
- 🔐 **VPNs:** WireGuard (lightweight) and OpenVPN Access Server (managed).
